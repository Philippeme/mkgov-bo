...
class InstitutionRepository extends ServiceEntityRepository
{
     ...
     */
    public function findPublishedDepartments(): array
    {
     ...
     */
    public function findPublishedInstitutionsWithFilters(array $filters): array
    {
        ...
        if (!empty($filters['search'])) {
            $qb->andWhere('i.iname LIKE :search OR i.hq LIKE :search OR i.department LIKE :search OR i.phonenumber LIKE :search OR i.email LIKE :search OR i.contactperson LIKE :search')
